# AI Nim
The goal of this project is to write an AI that teaches itself to play Nim through reinforcement learning.
...
Finally, the `choose_action` function, which selects an action to take in a given state (either greedily, or using the epsilon-greedy algorithm).
